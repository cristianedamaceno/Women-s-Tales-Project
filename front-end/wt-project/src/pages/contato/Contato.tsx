                ...
                <Grid item xs={6} alignItems="center">
                    <Box paddingX={10}>
                        <form onSubmit={handleSubmit(onSubmit)} id="form_contato">
                            ...
                            <TextField id="email" label="Email" variant="outlined" margin="normal" fullWidth {...register("email", { required: true, maxLength: 100, minLength: 10, pattern: {value: /^[A-Z0-9._%+-]+@[A-Z0-9.-]+\.[A-Z]{2,}$/i, message: "Endereço de email inválido!" } })} />
